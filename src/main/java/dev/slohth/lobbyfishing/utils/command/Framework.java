package dev.slohth.lobbyfishing.utils.command;
...
public class Framework implements CommandExecutor {
    ...
    private void defaultCommand(CommandArgs commandArgs) {
        commandArgs.getSender().sendMessage(commandArgs.getLabel() + " is not handled! Oh noes!");
    }
