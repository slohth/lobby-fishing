...
class ItemBuilder {
    ...
    constructor(serialized: String) {
        this.item = ItemSerializer.deserialize(serialized)
        this.meta = item.itemMeta!!
    }

    fun name(name: String): ItemBuilder { meta.setDisplayName(color(name)); return this }
    ...
    fun lore(lore: String): ItemBuilder { meta.lore = listOf(color(lore)); return this }

    fun lore(vararg lore: String): ItemBuilder { meta.lore = color(lore); return this }
    ...
    fun serialize(): String {
        return ItemSerializer.serialize(build())
    }
}